<%--
// ==============================================================================
// File Name           : MFPJobReportResult.aspx
// Description         : MFPJobReportResult Page
...
<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleDetailPage.master" AutoEventWireup="true"
    CodeFile="MFPJobReportResult.aspx.cs" Inherits="Report_MFPJobReportResult" Title="Untitled Page" %>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="cphbody" runat="Server">
    <asp:Table ID="tblDetail" runat="server" CellPadding="1" CellSpacing="1" BackColor="#019cff"
        ...
        <asp:TableHeaderRow ID="tblHRBigTitle" runat="server" CssClass="Table_Top_bg">
            <asp:TableHeaderCell RowSpan="2" Width="140px" Wrap="false" Height="55px">MFP型号</asp:TableHeaderCell>
            <asp:TableHeaderCell RowSpan="2" Width="140px" Wrap="false" >MFP序列号</asp:TableHeaderCell>
            <asp:TableHeaderCell RowSpan="2" Width="140px" Wrap="false">总使用量</asp:TableHeaderCell>
            <asp:TableHeaderCell RowSpan="2" Width="140px" Wrap="false">黑白量合计</asp:TableHeaderCell>
            <asp:TableHeaderCell RowSpan="2" Width="140px" Wrap="false">彩色量合计</asp:TableHeaderCell>
        </asp:TableHeaderRow>
