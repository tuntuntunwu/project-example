<%--
// ==============================================================================
// File Name           : RestrictInfoAdd.aspx
// Description         : Add Restriction Set Information Page
...
<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleEAMasterPage.master" AutoEventWireup="true"
    CodeFile="RestrictInfoAdd.aspx.cs" Inherits="RestrictionInfo_RestrictInfoAdd"
    Title="RestrictInfoAdd" %>
                        ...
                        <td style="width: 97%;" align="left" valign="top">
                            <table style="width: 100%; border: 0;" cellpadding="0" cellspacing="0">
                                ...
                                <tr class="Light_GrayFont">
                                    ...
                                    <td align="left" valign="center" style="padding-left: 1px; height: 35px">
...
<asp:Content ID="ContentFoot" ContentPlaceHolderID="cphfoot" runat="server">
    <asp:Button ID="btnNewRestrictionSetAdd" runat="server" Text="新配额追加" OnClick="btnUpdate_Click"
        ValidationGroup="UpdateRes" CssClass="Button_Medium" />&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button
