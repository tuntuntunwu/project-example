...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OsaMain4.aspx.cs" Inherits="OsaMain4"
    UICulture="Auto" %>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left" valign="middle">
                                                                                        ...
                                                                                        <asp:TextBox ID="txtPassword" TextMode="Password" keyboard="password" format='password'
                                                                                            runat="server" MaxLength="30" TabIndex="1" CssClass="Inputtextbox" ></asp:TextBox>
