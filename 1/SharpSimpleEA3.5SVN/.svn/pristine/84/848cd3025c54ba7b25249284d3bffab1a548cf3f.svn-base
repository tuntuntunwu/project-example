...
<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleEAReportMasterPage.master"
    AutoEventWireup="true" CodeFile="GroupJobReport.aspx.cs" Inherits="Report_GroupJobReport"
    Title="Untitled Page" %>
                                        ...
                                        <asp:GridView ID="CustomersGridView" runat="server" DataSourceID="SqlDataListSource"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="SUMUSER" HeaderText="用户数" SortExpression="SUMUSER">
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="57px" />
                                                    <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="Automatic_Wrap" Width="57px" />
                                                </asp:BoundField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                    </ItemTemplate>
...
<asp:Content ID="ContentFoot" ContentPlaceHolderID="cphfoot" runat="server">
    <div style="z-index: 4;">
        ...
        <asp:Button ID="btnExportCSV" runat="server" Text="全部导出" CssClass="Login_Button_bg"
            OnClick="btnExportSectionCSV_Click" />
    </div>
</asp:Content>
