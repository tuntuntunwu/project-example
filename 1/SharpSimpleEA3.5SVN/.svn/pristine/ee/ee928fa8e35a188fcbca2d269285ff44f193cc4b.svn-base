                                                ...
                                                <td align="left" valign="top" class="Login_centerbg" style="height: 500px;">
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <br/><br/>
                                                            <br/><br/>  
    <asp:label ID= "labelMessage" Text="注册成功！系统将于3秒后自动进入登陆界面，请稍候！" font-size="16px" font-weight="bold" ForeColor="LightGoldenrodYellow" runat="server" />    
    <br/><br/>  
    <asp:Label ID="LabelTips"   Height= "20px" Width = "450px" runat="server" Text="如没有自动跳转，请直接点击 [重新登录] 按钮，直接登录"></asp:Label>
      <br /><br /> 
    <asp:Button ID="btnUpdate" runat="server" Text="重新登录" OnClick="btnUpdate_Click"  CssClass="Login_Button_bg"/>
