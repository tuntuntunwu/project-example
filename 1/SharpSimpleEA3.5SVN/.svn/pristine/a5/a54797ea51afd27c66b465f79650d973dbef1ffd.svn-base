<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleEAMasterPage.master" AutoEventWireup="true"
    CodeFile="MFPList.aspx.cs" Inherits="UserInfo_MFPList" Title="" %>
                                        ...
                                        <asp:GridView ID="CustomersGridView" runat="server" DataSourceID="SqlDataListSource"
                                            ...
                                            <Columns>
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" CssClass="Uncheck_box"
                                                        Height="33px" />
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                  ...
                                                  <asp:BoundField DataField="FLG" SortExpression="FLG" HeaderText="限制状态" >
                                                   <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="15%" />
                                                  </asp:BoundField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
...
<div style="z-index: 4;">
    <asp:Button ID="btnBack" runat="server" Text="返回" CssClass="Login_Button_bg" OnClick="btnBack_Click" />&nbsp;&nbsp;&nbsp;<asp:Button ID="btnAllow" runat ="server"
    Text="允许" CssClass="Login_Button_bg" OnClick="btnAllow_Click"  /> &nbsp;&nbsp;&nbsp;<asp:Button ID="btnNotAllow" runat="server" Text="禁止" CssClass="Login_Button_bg" OnClick="btnNotAllow_Click"   />            
    </div>
</asp:Content>
