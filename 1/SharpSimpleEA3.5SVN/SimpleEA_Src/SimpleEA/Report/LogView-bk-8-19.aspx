...
<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleEALogMasterPage.master"
    AutoEventWireup="true" CodeFile="LogView-bk-8-19.aspx.cs" Inherits="LogInfo_LogView"
    Title="Untitled Page" %>
...
<asp:Content ID="ContentFoot" ContentPlaceHolderID="cphfoot" runat="server">
    <div style="z-index: 4;">
        <asp:Button ID="btnCSVOutPut" runat="server" Text="CSV文件导出" CssClass="Login_Button_bg"
            OnClick="btnCSVOutPut_Click" OnClientClick="flgbtnCSV = true;" />
        &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnExecute" runat="server" Text="明细表示" CssClass="Login_Button_bg"
