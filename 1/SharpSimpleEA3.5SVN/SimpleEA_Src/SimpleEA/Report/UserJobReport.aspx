<%--
// ==============================================================================
// File Name           : User Job Report.
// Description         : User Job Report Result Screen for SimpleEA
...
<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleEAReportMasterPage.master"
    AutoEventWireup="true" CodeFile="UserJobReport.aspx.cs" Inherits="Report_UserJobReport"
    Title="Untitled Page" %>
                                        ...
                                        <asp:GridView ID="CustomersGridView" runat="server" DataSourceID="SqlDataListSource"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="UserName" HeaderText="用户名" SortExpression="UserName">
                                                    ...
                                                    <ItemStyle Width="180px" CssClass="Automatic_Wrap" />
                                                </asp:BoundField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                    </ItemTemplate>
                                                ...
                                                <asp:BoundField DataField="FULLCopyTotal" HeaderText="彩色复印合计" SortExpression="FULLCopyTotal"
                                                    ...
                                                    <HeaderStyle CssClass="Automatic_Wrap" HorizontalAlign="Center" VerticalAlign="Middle"
                                                        Width="100px" />
                                                ...
                                                <asp:BoundField DataField="BWCopyTotal" DataFormatString="{0:N0}" HeaderText="黑白复印合计"
                                                    SortExpression="BWCopyTotal">
                                                ...
                                                <asp:BoundField DataField="FULLPrintTotal" DataFormatString="{0:N0}" HeaderText="彩色打印合计"
                                                    SortExpression="FULLPrintTotal">
                                                    <HeaderStyle CssClass="Automatic_Wrap" HorizontalAlign="Center" VerticalAlign="Middle"
                                                        Width="92px" />
                                                ...
                                                <asp:BoundField DataField="BWPrintTotal" HeaderText="黑白打印合计" SortExpression="BWPrintTotal"
                                                    DataFormatString="{0:N0}">
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="92px" />
                                                    <ItemStyle  Width="92px" HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
