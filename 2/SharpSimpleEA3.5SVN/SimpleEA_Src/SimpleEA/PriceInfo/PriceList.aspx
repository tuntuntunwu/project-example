<%--
// ==============================================================================
// File Name           : PriceList.aspx
// Description         : Price Set List Information Page
...
<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleEAMasterPage.master" AutoEventWireup="true"
    CodeFile="PriceList.aspx.cs" Inherits="PriceInfo_PriceList" Title="Untitled Page" %>
                                    ...
                                    <div class="Scroller-Container">
                                        <asp:GridView ID="CustomersGridView" runat="server" DataSourceID="SqlDataListSource"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField DataTextField="PriceNM" HeaderText="价格方案名称"
                                                    Text="编辑" SortExpression="PriceNM" DataNavigateUrlFields="PriceId"
                                                    DataNavigateUrlFormatString="AddPrice.aspx?PriceId={0}" ShowHeader="False">
                                                    <HeaderStyle Width="300px" VerticalAlign="Middle" HorizontalAlign="Center" />
...
<asp:Content ID="ContentFoot" ContentPlaceHolderID="cphfoot" runat="server">
    <div style="z-index: 4;">
        <asp:Button ID="btnAddNewGrp" runat="server" Text="价格添加" OnClick="btnAddNewRes_Click"
            CssClass="Button_Medium" />&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnDeleteGrp"
                runat="server" Text="删除选择的价格" OnClick="btnDeleteRes_Click" CssClass="Button_Larger" />
    </div>
</asp:Content>
<%-- the Button Item ED--%>
