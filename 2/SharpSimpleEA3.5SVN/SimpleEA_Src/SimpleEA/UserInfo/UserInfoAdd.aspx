...
<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleEAMasterPage.master" AutoEventWireup="true"
    CodeFile="UserInfoAdd.aspx.cs" Inherits="UserInfo_UserInfoAdd" Title="Untitled Page" %>
                            ...
                            <table style="width: 100%; height: 385px; border: 0;" cellpadding="0" cellspacing="0">
                                ...
                                <tr id="TR_ID1" class="Light_GrayFont">
                                    ...
                                    <td align="left" valign="middle">
                                        &nbsp;<asp:TextBox ID="txtUserName" runat="server" Width="300px" MaxLength="30" CssClass="Inputtextbox"></asp:TextBox><img
                                            alt="Req" src="../Images/Req_star.png" width="5px" height="5px" style="vertical-align: top;" /><asp:CustomValidator
                                                ID="valUserName" ControlToValidate="txtUserName" runat="server" ValidationGroup="UpdateUser"
                                                OnServerValidate="valUserName_ServerValidate" Display="Dynamic"></asp:CustomValidator><asp:RequiredFieldValidator
                                                    ID="rfvUserName" ControlToValidate="txtUserName" runat="server" Display="Dynamic"
                                                    ValidationGroup="UpdateUser"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                                        ID="revUserName" ControlToValidate="txtUserName" Display="Dynamic" runat="server"
                                                        ValidationGroup="UpdateUser"></asp:RegularExpressionValidator></td>
                                </tr>
                                    ...
                                    <td align="left" valign="middle">
                                        &nbsp;<asp:TextBox ID="txtLoginName" runat="server" Width="300px" MaxLength="30"
                                            CssClass="Inputtextbox"></asp:TextBox><img alt="Req" src="../Images/Req_star.png"
                                                width="5px" height="5px" style="vertical-align: top;" /><asp:CustomValidator ID="valLoginName"
                                                    ControlToValidate="txtLoginName" runat="server" ValidationGroup="UpdateUser"
                                                    OnServerValidate="valLoginName_ServerValidate" Display="Dynamic"></asp:CustomValidator><asp:RequiredFieldValidator
                                                        ID="rfvLoginName" ControlToValidate="txtLoginName" runat="server" Display="Dynamic"
                                                        ValidationGroup="UpdateUser"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                                            ID="revLoginName" ControlToValidate="txtLoginName" Display="Dynamic" runat="server"
                                                            ValidationGroup="UpdateUser"></asp:RegularExpressionValidator></td>
                                </tr>
                                <tr>
                                ...
                                <tr class="Light_GrayFont">
                                    ...
                                    <td align="left" valign="top" style="height: 35px;" class="VR_line">
                                        &nbsp;
                                    </td>
                                ...
                                <tr class="Light_GrayFont">
                                    ...
                                    <td align="left" valign="top">
                                        &nbsp;<asp:TextBox ID="txtPasswordConfirm" runat="server" Width="140px" MaxLength="30"
                                            CssClass="Inputtextbox" ></asp:TextBox><img alt="Req" src="../Images/Req_star.png"
                                                width="5px" height="5px" style="vertical-align: top;" /><asp:RequiredFieldValidator
                                ...
                                <tr class="Light_GrayFont">
                                    ...
                                    <td align="left" valign="top">
                                        ...
                                        <asp:RegularExpressionValidator
                                                ...
                                                ValidationGroup="UpdateUser" ValidationExpression="^([\w-\.]+)@([-\dA-Za-z]+\.)+[a-zA-Z]{2,}"  ErrorMessage="Email地址不合法"></asp:RegularExpressionValidator></td>
                                </tr>     
                                ...
                                <tr class="Light_GrayFont">
                                    ...
                                    <td align="left" valign="top" style="padding-left: 10px;">
                                        ...
                                        <asp:Button ID="btnMoeney" runat="server" Text="自定义" Visible="false" OnClick="btnSetRestrictionName_click"  CssClass="Select_button" Style="margin-top:3px;"/>
                                    </td>
                                </tr>
...
<asp:Content ID="contentfoot" ContentPlaceHolderID="cphfoot" runat="server">
    <asp:Button ID="btnUpdate" runat="server" Text="用户追加" OnClick="btnUpdate_Click" ValidationGroup="UpdateUser"
