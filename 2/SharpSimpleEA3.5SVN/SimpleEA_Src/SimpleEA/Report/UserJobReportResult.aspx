...
<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleDetailPage.master" AutoEventWireup="true"
    CodeFile="UserJobReportResult.aspx.cs" Inherits="Report_UserJobReportResult"
    Title="Untitled Page" %>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="cphbody" runat="Server">
    <asp:Table ID="tblDetail" runat="server" CellPadding="1" CellSpacing="1" 
        ...
        <asp:TableHeaderRow ID="tblHRBigTitle" runat="server" CssClass="Table_Top_bg">
            <asp:TableHeaderCell RowSpan="2" Width="140px" Wrap="false" Height="55px">用户名</asp:TableHeaderCell>
            <asp:TableHeaderCell RowSpan="2" Width="140px" Wrap="false">用户组名</asp:TableHeaderCell>
