<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterICCardForOSA4.aspx.cs" Inherits="RegisterICCardForOSA4" %>
...
<body onload="Login_ErrorShow();" leftmargin="0" topmargin="0"
    scroll="NO" class="bg">
    <form id="MFPForm" runat="server" class="osa_login">
        ...
        <table width="1024px" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="height: 408px" align="left" valign="top">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 408px">
                        <tr>
                            ...
                            <td align="left" valign="top">
                                <table id="IClogin_height" runat="server" border="0" cellpadding="0" cellspacing="0"
                                    style="height: 75px" width="100%">
                                </table>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" style="height: 38px">
                            </td>
                        </tr>
                        <tr>
                                                                            ...
                                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 179px">
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="2" align="center" valign="top" style="height: 48px;">
                                                                                        <!--Login Button -->
                                                                                        <asp:ImageButton runat="server" ID="btnLogIn" OnClick="btnLogIn_Click" 
                                                                                            ImageUrl="Images_mfp/Register.png" Height="35px" Width="142px" />
                                                                                        <!--End of the Login Button -->
                                                                                         &nbsp; &nbsp; 
                                                                                        <asp:ImageButton runat="server" ID="ImageButton1" OnClick="btnCancel_Click" 
                                                                                            ImageUrl="Images_mfp/Exit.png" Height="35px" Width="142px" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
