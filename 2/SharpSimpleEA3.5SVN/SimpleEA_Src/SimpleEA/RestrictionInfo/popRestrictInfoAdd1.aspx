                ...
                <tr>
                    <td style="height: 100px;" class="Black_Font_bold" align="center" valign="middle">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <input type="button" id="Button1" class="Login_Button_bg" value="确定sssss" onclick="callparent();" />
                        </table>
                    </td>
                </tr>
                <tr>
                                                    ...
                                                    ValidationGroup="UpdateRes"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                                        ...
                                                        ValidationGroup="UpdateRes"></asp:RegularExpressionValidator>
                                                                                                ...
                                                                                                <tr class="Light_GrayFont">
                                                                                                    ...
                                                                                                    <td align="left" valign="top">
                                      <asp:TextBox ID="txtAllQuota" runat="server" Width="250px" MaxLength="9" CssClass="Inputtextbox"></asp:TextBox><span style="height: 5px"><img alt="Req" src="../Images/Req_star.png"
                                            width="5px" height="5px" style="vertical-align: top;" /></span>
                                                ...
                                                <asp:RegularExpressionValidator
                                                        ...
                                                        ValidationGroup="UpdateRes" ValidationExpression="^([0-9]\d{0,4})$|^(0|[1-9]\d{0,4})\.(\d{1,2})$"></asp:RegularExpressionValidator>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr class="Light_GrayFont">
                                                                                                    <td align="left" valign="middle" style="height: 35px;">
                                                                                                    ...
                                                                                                    <td align="left" valign="top">
                                      <asp:TextBox ID="txtColorQuota" runat="server" Width="250px" MaxLength="9" CssClass="Inputtextbox"></asp:TextBox><span style="height: 5px"><img alt="Req" src="../Images/Req_star.png"
                                            width="5px" height="5px" style="vertical-align: top;" /></span>
                                      <asp:CustomValidator
