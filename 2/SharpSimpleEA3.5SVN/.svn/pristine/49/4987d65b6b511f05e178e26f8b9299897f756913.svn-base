...
<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleEAMasterPage.master" AutoEventWireup="true"
    CodeFile="GroupInfoEdit.aspx.cs" Inherits="GroupInfoEdit" Title="Untitled Page" %>
                    ...
                    <tr class="Light_GrayFont">
                        ...
                        <td style="width: 86%;" align="left" valign="middle">
                            &nbsp;<asp:TextBox ID="txtGroupName" runat="server" CssClass="Inputtextbox" MaxLength="30"
                                Width="400px"></asp:TextBox><img alt="Req" src="../Images/Req_star.png"
                                    width="5" height="5" style="vertical-align: top" /><asp:CustomValidator ID="valGroupName"
                                        ControlToValidate="txtGroupName" runat="server" ValidationGroup="UpdateGroupName"
                                        OnServerValidate="valGroupName_ServerValidate" Display="Dynamic"></asp:CustomValidator><asp:RequiredFieldValidator
                                            ID="rfvGroupName" ControlToValidate="txtGroupName" runat="server" Display="Dynamic"
                                            ValidationGroup="UpdateGroupName"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                                ID="revGroupName" ControlToValidate="txtGroupName" Display="Dynamic" runat="server"
                    ...
                    <tr class="Light_GrayFont">
                        ...
                        <td align="left" valign="top">
                            <div style="padding-left: 8px; padding-top: 9px; float:left; margin-right:15px;">
                                <asp:DropDownList ID="lstRestriction" runat="server" CssClass="changeMe Restrictionie6"
                                ...
                                <tr>
                                    <td style="height: 205px" align="left" valign="top">
                                        <div style="z-index: 1; position: static; padding-left: 10px; padding-right: 10px;">
                                            <table border="0" cellpadding="0" cellspacing="0" style="height: 178px" width="100%">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td align="center" style="height: 30px" valign="middle">
                                                        <asp:Button ID="btnToBelong" runat="server" CssClass="Addbutton" OnClick="btnToBelong_Click"
                                                            Text=">>" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="height: 30px" valign="middle">
                                                        <asp:Button ID="btnToNoBelong" runat="server" CssClass="Addbutton" OnClick="btnToNoBelong_Click"
                                                            Text="<<" /></td>
                                                </tr>
                                                <tr>
