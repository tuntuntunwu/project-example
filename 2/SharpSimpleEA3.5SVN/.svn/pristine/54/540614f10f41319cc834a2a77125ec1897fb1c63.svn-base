<%--
// ==============================================================================
// File Name           : Group Job Report.
// Description         : Group Job Report Result Screen for SimpleEA
...
<%@ Page Language="C#" MasterPageFile="~/Masterpage/SimpleEAReportMasterPage.master"
    AutoEventWireup="true" CodeFile="GroupUserJobReport.aspx.cs" Inherits="Report_GroupUserJobReport"
    Title="Untitled Page" %>
        ...
        <tr>
            ...
            <td align="left" valign="top">
                <table style="width: 100%; border: 0;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="left" valign="top" style="width: 97%; height: 300px" class="Scroll_td">
                            <div class="Container">
                                    ...
                                    <div class="Scroller-Container">
                                        <asp:GridView ID="CustomersGridView" runat="server" DataSourceID="SqlDataListSource"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="用户组名称" SortExpression="GroupName">
                                                    <ItemTemplate>
                                                        <asp:LinkButton runat="server" OnClick="btnGroupName_Click"
                                                            Text='<%# DataBinder.Eval(Container.DataItem,"GroupName")%>' 
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ID")%>' />
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="118px" />
                                                    <ItemStyle Wrap="true" CssClass="Automatic_Wrap"  Width="118px" />
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                    </ItemTemplate>
                                                ...
                                                <asp:BoundField DataField="SUMUSER" HeaderText="用户数" SortExpression="SUMUSER">
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="55px" />
                                                    <ItemStyle HorizontalAlign="Center" Wrap="true" CssClass="Automatic_Wrap" Width="55px" />
                                                </asp:BoundField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                    </ItemTemplate>
                                                ...
                                                <asp:BoundField DataField="FULLCopyTotal" HeaderText="彩色复印合计" SortExpression="FULLCopyTotal"
                                                ...
                                                <asp:BoundField DataField="GrayCopyTotal" DataFormatString="{0:N0}" HeaderText="黑白复印合计"
                                                    ...
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="93px" />
                                                ...
                                                <asp:BoundField DataField="Total" HeaderText="总使用量合计" SortExpression="Total" DataFormatString="{0:N0}">
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="93px" />
                                                    <ItemStyle HorizontalAlign="Right" Width="93px" />
                                                </asp:BoundField>
                                                <asp:TemplateField>
...
<asp:Content ID="ContentFoot" ContentPlaceHolderID="cphfoot" runat="server">
    <div style="z-index: 4;">
        <asp:Button ID="btnItemCount" runat="server" Text="统计" CssClass="Login_Button_bg"
         ...
         <asp:Button ID="btnExportCSV" runat="server" Text="全部导出" CssClass="Login_Button_bg"
