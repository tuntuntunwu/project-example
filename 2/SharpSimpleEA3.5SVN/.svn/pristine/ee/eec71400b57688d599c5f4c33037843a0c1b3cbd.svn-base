...
namespace PrintCopyService
{
	...
	public class SQLHelper
	{
        ...
        public SQLHelper(string ip, string user, string pwd)
        {
            servIp = ip;
            userId = user;
            passWd = pwd;
        ...
        {
            string connectstring = ServiceCommon.DBConnectionStrings; //ConfigurationManager.AppSettings["SimpleEAConnectionString"].ToString();
		...
		private void Open() 
		{
            ...
            string connectstring = ServiceCommon.GetAppSettingString("SimpleEAConnectionString");//ConfigurationManager.ConnectionStrings["SimpleEAConnectionString"].ConnectionString;
        ...
        private static SqlParameter[] FilterSqlParameter(SqlParameter[] prams)
        {
            //chen
