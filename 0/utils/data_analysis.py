...
if __name__ == '__main__':
    ...
    # objs_rm_prefixs(json_folder_path=r'C:\Users\Administrator\Desktop\cemian\crop')
    # 删除labelme json文件中的guojian前缀
    # objs_rm_guojian(json_folder_path=r'C:\Users\Administrator\Desktop\cemian\crop')
    # 显示labelme json文件夹中所有labels
    objs_labels(json_folder_path=r'C:\Users\Administrator\Desktop\cemian\crop')
