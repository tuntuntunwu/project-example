...
def split_train_val_test(yolo_folder_path, target_folder_path, test_ratio, val_ratio):
    '''
    ...
    total_txt = [txt for txt in os.listdir(yolo_folder_path) if txt.endswith('.txt')]
    ...
    for txt in total_txt:
        if txt in test_txt:
            if txt in val_txt:
                copy(os.path.join(yolo_folder_path, txt), os.path.join(os.path.join(target_folder_path, 'labels/val'), txt))
            else:
                copy(os.path.join(yolo_folder_path, txt), os.path.join(os.path.join(target_folder_path, 'labels/test'), txt))
        else:
            copy(os.path.join(yolo_folder_path, txt), os.path.join(os.path.join(target_folder_path, 'labels/train'), txt))
